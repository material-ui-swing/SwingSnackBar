...
public class TwoActionSnackbar extends SnackBar {
    ...
    public static TwoActionSnackbar make(Window contextView, String withMessage, String iconText, String secondIconText) {
        if(contextView == null || (withMessage == null || withMessage.isEmpty())){ //TODO check also secondIconText
            String message = "\n";
            if(contextView == null){
    ...
    public static TwoActionSnackbar make(Window contextView, String withMessage, String iconText, Icon secondIconText) {
        if(contextView == null || (withMessage == null || withMessage.isEmpty())){ //TODO check also secondIconText
            String message = "\n";
            if(contextView == null){
                message = "- Context View null, this propriety should be an instance of Window swing component\n";
        ...
        return new TwoActionSnackbar(contextView, withMessage, new JLabel(iconText), new JLabel(secondIconText));
    }
