...
public class TwoActionContainer extends SnackBarContainer {
  ...
  public TwoActionContainer(
      SnackBar snackBar, JLabel snackBarText, JLabel secondAction, JLabel snackBarIcon) {
    super(snackBar, snackBarText, snackBarIcon);
    this.secondAction = secondAction;
  }

  public TwoActionContainer(
      SnackBar snackBar, JLabel snackBarText, JLabel secondAction, Icon snackBarIcon) {
    super(snackBar, snackBarText, snackBarIcon);
    this.secondAction = secondAction;
  }
  ...
  public Dimension getDimension() {
    ...
    if (this.snackBarIcon != null
        && snackBarIcon.getIcon() != null
        && this.secondAction == null
        && this.secondAction.getIcon() != null) {
      width =
          this.snackBarText
                  .getFontMetrics(this.snackBarText.getFont())
                  .stringWidth(this.snackBarText.getText())
      ...
      if (this.snackBarIcon != null) {
        ...
        width +=
            (this.snackBarIcon.getText() != null ? this.snackBarIcon.getText().length() * 8 : 10)
                + gap;
      }
      if (this.secondAction != null) {
        this.secondAction.setHorizontalTextPosition(SwingConstants.RIGHT);
        width +=
            (this.secondAction.getText() != null ? this.secondAction.getText().length() * 8 : 10)
                + gap;
      }
    }
    width += gap;
  ...
  /**
   * This method decided the position of the component such as secondAction.
   *
   * <p>TODO I should be use another layout, because with BorderLayout is not possible make this
   * change.
   */
  @Override
